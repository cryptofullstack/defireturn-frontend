...
const Wallet = ({ updateMenu, openMenu, allowMenu }) => {
        ...
        <div className="sub-main-board-h">
          ...
          <div className="wallet-sup-title">
            ...
            <div className="inline-pos">
              <img className="supp-img" src="../assets/images/eth-chain.png" />
              <img className="supp-img" src="../assets/images/bnb-chain.png" />
              <img className="supp-img" src="../assets/images/avalanche-chain.png" />
              <img className="supp-img" src="../assets/images/polygon-chain.png" />
              <img className="supp-img" src="../assets/images/fantom-chain.png" />
            </div>
          </div>
        </div>
      </div>
